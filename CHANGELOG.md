...
## [0.2.0]
### Added
- Added a fixed panel in the top-left corner displaying all existing segments.

## [0.1.4]
### Fixed
- Fixed Continuous road popup bug.

## [0.1.3]
### Fixed
- Removed unsued HarmonyX package which was causing conflicts with **ExtraDetailingTools** mod.

## [0.1.2]

### Fixed
- (Thanks to @bc-lee) Duplicate tooltip path conflict should no longer appear.

## [0.1.1]

### Fixed
- Precise angles should be visible when drawing straight roads from an existing road.
